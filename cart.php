...
<body>
    ...
    <section>
        <section id="cart_items">
            <div class="container">
                <h3 style="text-align: center;font-size: 5rem;" >Đơn Hàng của bạn</h3>
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        <thead>
                            <tr class="cart_menu" style="background: #7B7BC0; font-size: 2em;color: cornsilk; " >
                                <td class="image"></td>
                ...
                <?php }
                    ...
                    <h3>
                        <p style=text-align:center;background-color:#7B7AF6;padding:10px;color:white>Tổng Cộng: <?php echo number_format($total) ?> VND </p>
                    </h3>
                    <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="processOrder.php">
                        ...
                        <div class="form-group col-md-12">
                            <a class="btn btn-default update" href="index.php" style="background: forestgreen;color:aliceblue">Tiếp tục mua hàng</a>
                            <a class="btn btn-default check_out" href="change.php?control=4" style="background: #a53535;color:aliceblue">Xóa tất cả</a>
                            <input type="submit" name="submitOrder" class="btn btn-primary pull-right" value="Đặt hàng" style="background: forestgreen;">
                        </div>
                    </form>
                </div>
            </div>
