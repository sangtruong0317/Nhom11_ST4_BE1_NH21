			...
			<div class="col-md-4 col-xs-6">
				<div class="shop">
					...
					<div class="shop-body">
						...
						<a href="product.php?type_id=123" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
			</div>
			<!-- /shop -->
			...
			<div class="col-md-4 col-xs-6">
				<div class="shop">
					...
					<div class="shop-body">
						...
						<a href="product.php?type_id=124" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
			</div>
			<!-- /shop -->
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<a href="cart.php?id=<?php echo $value['id'] ?>" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</a>
											</div>
